defmodule ImsWeb.EventLiveTest do
  use ImsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Ims.WelfareFixtures

  @create_attrs %{status: "some status", description: "some description", title: "some title", amount_paid: "120.5"}
