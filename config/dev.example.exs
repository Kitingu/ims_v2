...
config :ims, ImsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "YfGUY/L/WkeUOBJyA0ISutnzPnxDlledwUfBUQsslzq54LppAlO0qyVi+UYbLaxO",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ims, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ims, ~w(--watch)]}
  ]
...
config :ims, ImsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ims_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ims, dev_routes: true
